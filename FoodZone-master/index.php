                    ...
                    <div class="row mt-5">
                        <div class="col-lg-5 col-md-6 align-self-center py-5">
                            ...
                            <div class="dishes-text">
                                ...
                                <p class="pt-3">Sarjapur Road Behind MK Retail, Before Wipro Corporate Office, Bengaluru 560034 India!?</p>
                                <h3 class="special-dishes-price">29.99<sup>INR</sup></h3>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2 py-5">
                            ...
                            <div class="dishes-text">
                                ...
                                <p class="pt-3">Sarjapur Road Behind MK Retail, Before Wipro Corporate Office, Bengaluru 560034 India!</p>
                                <h3 class="special-dishes-price">49.99<sup>INR</sup></h3>
                            ...
                            <div class="menus d-flex align-items-center">
                                ...
                                <div class="text-wrap">
                                    <div class="row align-items-start">
                                        ...
                                        <div class="col-4">
                                            <h4 class="text-muted menu-price"><?php echo $data['price'] ?><sup>INR</sup></h4>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="team-card mb-5">
                                ...
                                <div class="team-desc">
                                    <h4 class="mb-0">Vikaas Khanna</h4>
                                    <p class="mb-1">CEO</p>
                        ...
                        <div class="col-md-3">
                            <div class="team-card mb-5">
                                ...
                                <div class="team-desc">
                                    <h4 class="mb-0">sanjeev kapoor</h4>
                                    <p class="mb-1">Chef</p>
                                    <ul class="list-inline mb-0 team-social-links">
                                        <li class="list-inline-item">
                                            <a href="#">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer-widget pr-lg-5 pr-0">
                            ...
                            <p>Sarjapur Road Behind MK Retail, Before Wipro Corporate Office, Bengaluru 560034 India!</p>
